...
var (
	...
	// HasAVX512 requires AVX-512F and VL plus AVX-512DQ for the leaf kernels'
	// KMOVB instructions. Every CPU shipping VL also ships DQ, but the gate
	// should match the instructions actually used.
